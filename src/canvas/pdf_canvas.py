...
class PdfCanvas(tk.Canvas):
    ...
    def show_page(self, pix, page_extent, safe_margin, elements):
        ...
        # Compute safe area in PDF coordinates (note: PDF y axis origin is bottom-left)
        # This mirrors the calculation in Pdf.recalculate_safe_area which uses
        ...
        # Convert PDF coordinates to image (canvas) coordinates using same transform
        # as used for element rectangles (y flipped)
